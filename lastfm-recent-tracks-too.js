...
//					console.log('Null');
					html += '<li class="lfm-track"><a href="'+item.url+'" class="lfm-artwork" target="_blank"><img src="'+nullalbum+'" alt="'+item.album['#text']+'" /></a><span class="lfm-trackname">'+item.name+  ' - ' + item.artist['#text'] + '</span></li>';
				} else {
//					console.log('img: '+item.image[1]['#text']);
					html += '<li class="lfm-track"><a href="'+item.url+'" class="lfm-artwork" target="_blank"><img src="'+item.image[2]['#text']+'" alt="'+item.album['#text']+'" /></a><span class="lfm-trackname">'+item.name+ ' - ' + item.artist['#text'] + '</span></li>';
				}
